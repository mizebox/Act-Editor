...
// Type: ActEditor.Core.Scripts.ActionCopyAt
...
namespace ActEditor.Core.Scripts
{
  ...
  {
    public object DisplayName => (object) "Copy action and replace to...";

    public string Group => "Action";

    public string InputGesture => "Alt-G";
      ...
      int[] selectedLayerIndexes)
    {
      ...
      try
      {
        try
        {
          ...
          actionInsertDialog.Mode = ActionInsertDialog.EditMode.Replace;
