...
// Type: ActEditor.Core.Scripts.ActionSwitchSelected
...
namespace ActEditor.Core.Scripts
{
  ...
  {
    public object DisplayName => (object) "Switch action to...";

    public string Group => "Action";

    public string InputGesture => "Alt-M";
      ...
      int[] selectedLayerIndexes)
    {
      ...
      try
      {
        try
        {
          ...
          actionInsertDialog.Mode = ActionInsertDialog.EditMode.Switch;
