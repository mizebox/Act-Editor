...
// Type: ActEditor.Core.Scripts.FrameCopyAt
...
namespace ActEditor.Core.Scripts
{
  ...
  {
    public object DisplayName => (object) "Copy frame and replace to...";

    public string Group => "Frame";

    public string InputGesture => "Ctrl-G";
      ...
      int[] selectedLayerIndexes)
    {
      ...
      try
      {
        ...
        frameInsertDialog.Mode = FrameInsertDialog.EditMode.Replace;
