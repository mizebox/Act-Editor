...
// Type: ActEditor.Core.Scripts.FrameSwitchSelected
...
namespace ActEditor.Core.Scripts
{
  ...
  {
    public object DisplayName => (object) "Switch frame to...";

    public string Group => "Frame";

    public string InputGesture => "Ctrl-M";
      ...
      int[] selectedLayerIndexes)
    {
      ...
      try
      {
        ...
        frameInsertDialog.Mode = FrameInsertDialog.EditMode.Switch;
