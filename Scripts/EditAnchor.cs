...
// Type: ActEditor.Core.Scripts.EditAnchor
...
namespace ActEditor.Core.Scripts
{
  public class EditAnchor : IActScript
  {
    ...
    {
      this.ActEditor._framePreview.EditAnchors();
    }
    ...
    public object DisplayName => (object) "Edit frame anchor position";

    public string Group => "Anchors";

    public string InputGesture => "Ctrl-K";
