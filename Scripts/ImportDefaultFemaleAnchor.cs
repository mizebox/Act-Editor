...
// Type: ActEditor.Core.Scripts.ImportDefaultFemaleAnchor
...
namespace ActEditor.Core.Scripts
{
  public class ImportDefaultFemaleAnchor : IActScript
  {
      ...
      int[] selectedLayerIndexes)
    {
      ...
      try
      {
        Act loadedAct = new Act((MultiType) ApplicationManager.GetResource("ref_head_f.act"), new Spr());
        act.Commands.Begin();
    ...
    public object DisplayName => (object) "Set default (female)";
